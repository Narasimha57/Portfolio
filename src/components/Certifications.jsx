...
const Certifications = () => {
  ...
  return (
    ...
    <br /><br />
    <img src="./nptel.jpg" alt="NPTEL"  className='md:px-32 px-6 rounded-2xl'/><br /><br />
    <h4 className='font-bold text-2xl px-2 md:text-4xl md:px-6 md:font-bold'>
        2. Google Developer Certificate</h4><br />
