    ...
    <section >
      <div className='text-black flex md:flex-row justify-center items-center py-20'>
        ...
        {/* <h1 className='text-yellow-500 font-bold justify-center flex items-center text-4xl md:text-6xl'>About Me</h1><br />
            ...
            <br /> */}
            <p className='text-gray-600 font-semibold md:font-semibold mb-6 whitespace-normal truncate text-justify font-sans text-lg mt-0'>I recently completed my Bachelor's degree in Computer Engineering, specializing in Software Engineering, from Balaji Institute of Technology and Science in Warangal, achieving an aggregate percentage of 7.52. Before this, I earned a Diploma in Mining Engineering from Daripally Anantha Ramulu College of Engineering and Technology in Khammam, following my secondary education at ZPP Secondary School. Throughout my studies, I developed a strong interest in software development, culminating in my project titled "College Bus Live Tracking System," which enhanced my skills in real-time tracking and user interface design. I have a solid foundation in programming languages like Python and Java, along with a good understanding of Data Structures and Algorithms (DSA) and the Software Development Life Cycle (SDLC). Additionally, I am familiar with web technologies such as HTML, CSS, and JavaScript, enabling me to contribute effectively to both front-end and back-end tasks. In my free time, I enjoy gaming, which helps me develop strategic thinking and problem-solving skills. I am eager to leverage my skills and knowledge in a professional setting and look forward to contributing to innovative projects in the technology field.
          </p>
